...
class uc_homeModule extends MainBaseModule
{
	...
	public function index()
	{
		...
		$data = request_api("uc_home","index",$param);
	...
	public function show()
	{
	    ...
	    $data = request_api("uc_home","show",$param);
	...
	public function do_fav_topic(){
	    ...
	    $data = request_api("uc_home","do_fav_topic",$param);
	...
	public function do_reply(){
	    ...
	    $data = request_api("uc_home","do_reply",$param);
	...
	public function check_reply_user(){
	    ...
	    $data = request_api("uc_home","check_reply_user",$param);
	...
	public function del_reply(){
	    ...
	    $data = request_api("uc_home","del_reply",$param);
	...
	public function load_move_reply(){
	    ...
	    $data = request_api("uc_home","load_move_reply",$param);
	...
	public function publish(){
	    ...
	    $data = request_api("uc_home","publish",$param);
