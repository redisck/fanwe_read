...
class YouhuiAction extends CommonAction{
	...
	public function update() {
		...
		// 先获取需要更新的match数据
		$old_data = $GLOBALS['db']->getAll("select id, name_match_row, deal_cate_match_row, locate_match_row from ".DB_PREFIX."youhui where id = '".$data['id']."'");
	...
	//删除指定记录
		...
		if (isset ( $id )) {
				...
				// 删除关键字
				require_once APP_ROOT_PATH."system/model/search_key_words.php";
				deleteKeyWordsApi( explode(',', $id), 2);
