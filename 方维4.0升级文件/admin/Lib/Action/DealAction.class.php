...
class DealAction extends CommonAction{
	...
	public function edit() {		
		...
		$vo['max_bought'] = intval($GLOBALS['db']->getOne("select stock_cfg from ".DB_PREFIX."deal_stock where deal_id = ".$id));
	...
	public function update() {
		...
		// 先获取需要更新的match数据
		$old_data = $GLOBALS['db']->getAll("select id, is_shop, name_match_row, deal_cate_match_row,  shop_cate_match_row,  locate_match_row, tag_match_row from ".DB_PREFIX."deal where id = '".$data['id']."'");
