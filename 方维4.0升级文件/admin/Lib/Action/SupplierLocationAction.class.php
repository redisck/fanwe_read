...
class SupplierLocationAction extends CommonAction{
	...
	public function update() {
		...
		// 先获取需要更新的match数据
		$old_data = $GLOBALS['db']->getAll("select id, name_match_row, deal_cate_match_row, locate_match_row, tags_match_row from ".DB_PREFIX."supplier_location where id = '".$data['id']."'");
