...
class DealCouponAction extends CommonAction{
	public function index()
	{
		...
		if($deal_info['is_coupon']==0&&$deal_info['is_pick']==0)
		{
...
public function update() {
	...
	public function export_csv($page = 1)
	{
		...
		if($list)
		{
			...
			$coupon_value = array('id'=>'""', 'password'=>'""','deal_id'=>'""',  'order_deal_id'=>'""','number'=>'""','order_id'=>'""','user_id'=>'""','mobile'=>'""','begin_time'=>'""','end_time'=>'""','confirm_time'=>'""');
			if($page == 1)
	    	...
	    	foreach($list as $k=>$v)
			{
				...
				if($v['deal_type']==1)
					...
					$coupon_value['number'] = iconv('utf-8','gbk','"1"');
