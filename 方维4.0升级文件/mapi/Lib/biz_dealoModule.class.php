...
//         echo "select deal_id,count(*) as count from ".DB_PREFIX."deal_coupon where deal_id in(".implode(",",$deal_ids).")";exit;
     ...
     *    [deal_info] => Array   ：array 团购详细数据
        ...
        [deals] => Array    ：array 消费券 用户消费列表
        (
            [0] => Array
                (
                    [id] => 170     ：int 用户的消费券ID
                    [sn] => 96832623    ：消费券验证码
                    [confirm_time] => 1432257223    ：string 消费券消费时间
                    [user_name] => fanwe        ：string 消费券消费会员 
                    [f_confirm_time] => 2015-05-22  ：string 格式化消费券使用时间
                )
        )
