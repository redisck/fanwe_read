        ...
        public function password_check(){
            ...
            else
            {
                ...
                if(md5($check_pwd) == $pwd){
                    output($root,1,"密码验证通过");
                }else{
                    output($root,0,"密码验证失败");
                }
            }
            output($root);
        }
        ...
        public function do_withdraw(){
            ...
            else
            {
                ...
                if($GLOBALS['request']['bank_name']){
                    ...
                    if($bank_name=="")
                    {
                            output($root,0,"请输入开户行全称");
                    }
                    if($bank_account=="")
                    {
                            output($root,0,"请输入开户行账号");
                    }
                    if($bank_user=="")
                    {
                            output($root,0,"请输入开户人真实姓名");
                    }
                    if($bank_mobile=="")
                    {
                            output($root,0,"请输入银行预留手机号");
                    }
