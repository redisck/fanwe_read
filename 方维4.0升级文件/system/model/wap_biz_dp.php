<?php 
function wap_biz_get_dp_list($limit,$type,$id,$is_bad='',$supplier_id='')
{
    /*参数列表*/
    $deal_id = 0;
    $youhui_id = 0;
    ...
    if($type=="deal")
    {
        ...
        $relate_data_supplier_id = $deal_info['supplier_id'];
    }
    elseif($type=="store")
    {
        $location_id = $id;
        ...
        $relate_data_supplier_id = $location_info['supplier_id'];
    }
    elseif($type=="youhui")
    {
        $youhui_id = $id;
        ...
        $relate_data_supplier_id = $youhui_info['supplier_id'];
    }
    elseif($type=="event")
    {
        $event_id = $id;
        ...
        $relate_data_supplier_id = $event_info['supplier_id'];
    }
    if($relate_data_supplier_id!=$supplier_id)
        return false;
